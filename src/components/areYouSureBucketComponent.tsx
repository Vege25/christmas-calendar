...
const AreYouSureBucketComponent: React.FC<AreYouSureComponentProps> = ({
  onConfirm,
  onCancel,
}) => {
      ...
      <div className='bg-white rounded-lg shadow-lg w-80'>
        <div className='px-4 py-2 text-center'>
          ...
          <p className='text-sm text-gray-500'>
            Haluatko varmasti merkata tämän tehdyksi? Päätöstä ei pysty
            peruuttamaan.
          </p>
        </div>
...
export default AreYouSureBucketComponent;
